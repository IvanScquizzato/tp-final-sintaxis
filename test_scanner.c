...
TOKEN scanner() {
    ...
    int tabla[NUMESTADOS][NUMCOLS] = {
        { 1, 3, 5, 6, 7, 8, 9, 10, 11, 14, 13, 0, 15,16,14,21 },
        { 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,2,2 ,2},
        { 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,14,14, 14, 14,14 },
        { 4, 3, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,14,14, 4,14 },
        { 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,14,14, 14,14 },
        { 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,14,14, 14,14 },
        { 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,14,14, 14,14 },
        { 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,14,14, 14,14 },
        ...
        { 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,14,14, 14,14 },
        { 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,14,14, 14,14 },
        { 14, 14, 14, 14, 14, 14, 14, 14, 14, 12, 14, 14, 14,14,14 ,14},
        { 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,14,14, 14,14 },
        { 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,14,14, 14,14 },
       { 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,14,14, 14,14 },
       { 19, 19, 14, 14, 14, 14, 14, 14, 14, 17, 14, 19,14,14, 14,14 },
       { 20, 20, 14, 14, 14, 14, 14, 14, 14, 18, 14, 20,14,14, 14,14 },
       { 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,14,14, 14,14 },
       { 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,14,14, 14,14 },
       { 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,14,14, 14,14 },
       { 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,14,14, 14,14 },
    ...
    int car;       // Carácter leído
    int col;       // Columna correspondiente en la tabla
    int estado = 0; // Estado inicial
    int i = 0;      // Posición en el buffer
    ...
    } while (!estadoFinal(estado) && !(estado == 14)); // Repetir hasta estado final o error
    ...
    switch (estado) {
        ...
        case 4: // Constante numérica
            if (col != 11) {
                ungetc(car, in);
                buffer[i-1] = '\0';
            }
            // Verificar si es real (contiene '.')
            for (int j = 0; j < i; j++) {
                if (buffer[j] == '.') return REAL;
            }
            return ENTERO;
...
int estadoFinal(int e) {
    if (e == 0 || e == 1 || e == 3 || e == 11 || e == 14 || e == 15 || e==16 || e==21) return 0;
    return 1;
}

// Determina la columna correspondiente a un carácter
int columna(int c) {
